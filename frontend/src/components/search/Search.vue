  ...
  <div class="search">
    ...
    <div class="search-content1">
      <div class="search-content1-search">
        <select class="content1-search-select" name="OTA">
          <option value="hotelStory">호텔스토리</option>
          <option value="onda">온다</option>
        </select>
        <input id="search-word" class="content1-search-input" type="text" placeholder="어디로 향하시나요?"><button type="button" class="content1-search-button" @click="search()">검색</button>
      </div>
      <div class="search-content1-result">검색된 숙소: {{ result }}개</div>
    </div>
